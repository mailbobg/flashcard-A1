...
ALPHABET = [
    ...
    ["D", "deː",         "de",        "Deutsch",   None],
    ["E", "eː",          "e",         "Essen",     "读「诶」不读「衣」——英语 E 读 /iː/，德语不是"],
    ["F", "ɛf",          "eff",       "Frau",      None],
    ["G", "ɡeː",         "ge",        "gut",       "读「给」不读「杰」"],
    ["H", "haː",         "ha",        "Haus",      None],
    ["I", "iː",          "i",         "ich",       "读「衣」——和 E 正好是英语的反过来"],
    ["J", "jɔt",         "jot",       "ja",        "读「幼特」，字母名不是英语的「杰」"],
    ["K", "kaː",         "ka",        "Kind",      None],
    ["L", "ɛl",          "el",        "Lehrer",    None],
    ["M", "ɛm",          "em",        "Mutter",    None],
    ["N", "ɛn",          "en",        "Name",      None],
    ["O", "oː",          "o",         "Obst",      None],
    ["P", "peː",         "pe",        "Post",      None],
    ["Q", "kuː",         "ku",        "Quittung",  "总是跟着 u，读 /kv/：Quittung ≈ 「克维通」"],
    ["R", "ɛʁ",          "err",       "rot",       None],
    ["S", "ɛs",          "es",        "Sonne",     None],
    ["T", "teː",         "te",        "Tag",       None],
    ["U", "uː",          "u",         "Uhr",       None],
    ["V", "faʊ",         "vau",       "Vater",     "字母名读「fau」，发音也是 /f/——不是英语的 /v/"],
    ["W", "veː",         "we",        "Wasser",    "字母名读「vee」，发音是 /v/——英语的 W 音德语里没有"],
    ["X", "ɪks",         "iks",       "Taxi",      None],
    ["Y", "ˈʏpsilɔn",    "üpsilon",   "Yoga",      "字母名最长，拼写题里出现要反应过来"],
    ["Z", "tsɛt",        "zett",      "Zeit",      "读「采特」，发 /ts/ 不是 /z/"],
    ["Ä", "ɛː",          "ä",         "Äpfel",     "念作 A-Umlaut。开口比 e 大"],
    ["Ö", "øː",          "ö",         "hören",     "念作 O-Umlaut。撅嘴发 e，中文没有这个音"],
    ["Ü", "yː",          "ü",         "Tür",       "念作 U-Umlaut。撅嘴发 i，接近普通话「绿」的韵母"],
