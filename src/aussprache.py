...
# 字段：[字母, 字母名(IPA), 字母名的德语可读拼写(TTS 用), 例词, 中文提示]
# 字母名拼写按德语正字法写成 TTS 能读准的串（如 A 写 ah，TTS 读 /aː/）。
ALPHABET = [
    ["A", "aː",          "ah",        "Apfel",     None],
    ["B", "beː",         "beh",       "Buch",      None],
    ["C", "tseː",        "tseh",      "Computer",  "单独的 C 少见，多出现在 ch / sch 组合里"],
    ["D", "deː",         "deh",       "Deutsch",   None],
    ["E", "eː",          "eh",        "Essen",     "读「诶」不读「衣」——英语 E 读 /iː/，德语不是"],
    ["F", "ɛf",          "eff",       "Frau",      None],
    ["G", "ɡeː",         "geh",       "gut",       "读「给」不读「杰」"],
    ["H", "haː",         "hah",       "Haus",      None],
    ["I", "iː",          "ie",        "ich",       "读「衣」——和 E 正好是英语的反过来"],
    ["J", "jɔt",         "jott",      "ja",        "读「幼特」，字母名不是英语的「杰」"],
    ["K", "kaː",         "kah",       "Kind",      None],
    ["L", "ɛl",          "ell",       "Lehrer",    None],
    ["M", "ɛm",          "emm",       "Mutter",    None],
    ["N", "ɛn",          "enn",       "Name",      None],
    ["O", "oː",          "oh",        "Obst",      None],
    ["P", "peː",         "peh",       "Post",      None],
    ...
    ["T", "teː",         "teh",       "Tag",       None],
    ["U", "uː",          "uh",        "Uhr",       None],
    ["V", "faʊ",         "fau",       "Vater",     "字母名读「fau」，发音也是 /f/——不是英语的 /v/"],
    ["W", "veː",         "veh",       "Wasser",    "字母名读「vee」，发音是 /v/——英语的 W 音德语里没有"],
    ["X", "ɪks",         "iks",       "Taxi",      None],
    ["Y", "ˈʏpsilɔn",    "üpsilon",   "Yoga",      "字母名最长，拼写题里出现要反应过来"],
    ["Z", "tsɛt",        "tsett",     "Zeit",      "读「采特」，发 /ts/ 不是 /z/"],
    ["Ä", "ɛː",          "äh",        "Äpfel",     "念作 A-Umlaut。开口比 e 大"],
    ["Ö", "øː",          "öh",        "hören",     "念作 O-Umlaut。撅嘴发 e，中文没有这个音"],
    ["Ü", "yː",          "üh",        "Tür",       "念作 U-Umlaut。撅嘴发 i，接近普通话「绿」的韵母"],
    ["ß", "ɛsˈtsɛt",     "eszett",    "Straße",    "念作 Eszett 或 scharfes S，只发 /s/，永远不大写"],
]
